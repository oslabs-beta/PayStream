...
import getOppRecordType from "./fetchSalesforceAPI.js";
...
salesforceController.run = async () => {
  try {
    ...
    eventEmitter.on("data", (event) => {
      ...
      console.log("PUBSUB APPI recordId: ", recordId);

      /**
       * assign the evaluated result of invoking getOppRecordType function to id variable
       */
      const id = getOppRecordType(recordId);
